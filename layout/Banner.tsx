  ...
  return (
    <div className="relative py-5 lg:py-20 h-152 lg:h-168">
      ...
      <ContentWrapper className="flex-col items-start">
        ...
        <h2 className={`mt-8 lg:mt-20 text-white text-38/16 lg:text-45/16 leading-11.5 lg:leading-14 font-lato font-bold max-w-72 lg:max-w-150`}>{title1}</h2>
        <h2 className={`mb-5 text-white text-38/16 lg:text-45/16 leading-11.5 lg:leading-14 font-lato font-bold max-w-72 lg:max-w-150`}>{title2}</h2>
