...
const Footer = () => (
  <Section>
    <div className="flex bg-dark px-3 md:px-0 md:py-32 flex-col-reverse md:flex-row items-center">
      <div className="flex flex-col md:px-32 md:items-start items-center my-16 md:my-0">
      ...
      <div className="flex items-center text-white max-w-25">
      ...
      <div className="flex md:justify-start justify-between md:flex-col md:px-32 my-16 md:my-0">
