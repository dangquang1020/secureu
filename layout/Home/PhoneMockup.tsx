...
const PhoneMockup = () => {
  ...
  return (
    <Section className="relative bg-dark pt-14 lg:py-20">
      ...
      <div className="relative flex justify-center mx-auto lg:absolute lg:left-1/2 transform translate-y-14/100 -mt-24 lg:mt-0 lg:-translate-x-1/2 lg:-translate-y-2 lg:-top-24 max-w-100">
